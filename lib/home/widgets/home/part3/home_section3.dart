      ...
      child: Column(
        ...
        children: [
          ...
          CompletedProjectBox(
            ...
            description:
                'تم تأهيل المنزل بالكامل وتوفير الاحتياجات الأساسية من عزل وتدفئة، ما ضمن بيئة معيشية آمنة وكريمة للعائلة. المشروع أعاد الأمل والاستقرار لأسرة كانت على وشك فقدان مأواها الوحيد.',
            photoUrl: "assets/images/completedproject3.jpg",
          ),
        ],
      ),
    );
